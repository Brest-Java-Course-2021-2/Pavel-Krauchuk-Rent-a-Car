...
public class CarControllerIT {
    ...
    public void shouldUpdateCar() throws Exception {
        ...
        Optional<Car> updatedDepartmentOptional = carService.findById(id);
        assertTrue(updatedDepartmentOptional.isPresent());
        assertEquals(updatedDepartmentOptional.get().getCarId(), id);
        assertEquals(updatedDepartmentOptional.get().getModel(),carOptional.get().getModel());
